module.exports.issue = {
  ...
  issue: {
    ...
    milestone: {
      ...
      title: 'v1.6',
      description:
        'Bug fixes about payment and flow for user, as well fixings for language preferences',
      creator: {
        login: 'alexanmtz',
        id: 88840,
        node_id: 'MDQ6VXNlcjg4ODQw',
  ...
  repository: {
    ...
    collaborators_url:
      'https://api.github.com/repos/worknenjoy/gitpay/collaborators{/collaborator}',
