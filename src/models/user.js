...
module.exports = (sequelize, DataTypes) => {
  const User = sequelize.define('User', {
    ...
    pending_email_change: DataTypes.STRING,
    email_change_token: DataTypes.STRING,
    email_change_token_expires_at: DataTypes.DATE,
    email_change_requested_at: DataTypes.DATE,
    email_change_attempts: DataTypes.INTEGER,
