...
export async function updateUserBankAccount({ userParams, bank_account }: UserBankAccountUpdateParams) {
  ...
  const bankAccount = (id && bankAccounts.data.find((b: any) => b.id === id)) || bankAccounts.data[0]
