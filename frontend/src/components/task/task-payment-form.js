            ...
            <div className={classes.details}>
              <CardContent className={classes.content}>
                ...
                <form className={classes.formPayment} action='POST'>
                  ...
                  <Button style={{ marginLeft: 20 }} disabled={!this.state.currentPrice} onClick={() => this.handlePayment('PaymentDialog')} variant='contained' color='primary' className={classes.btnPayment}>
                  ...
                  <Button disabled={!this.state.currentPrice} onClick={() => this.handlePayment('PaypalPaymentDialog')} variant='contained' color='primary' className={classes.btnPayment}>
