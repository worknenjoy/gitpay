          ...
          <div className={classes.mainlist}>
            <List>
              <ListItem className={classes.listIconTop}>
                ...
                <ListItemText primary="Para todos os envolvidos"
              ...
              <ListItem className={classes.listIconTop}>
                ...
                <ListItemText primary="Para todos os níveis"
              ...
              <ListItem className={classes.listIconTop}>
                ...
                <ListItemText primary="Aprenda na prática ou ganhe trabalhando com o que você domina"
