...
class CustomPaginationActionsTable extends React.Component {
  ...
  render () {
    const { classes, walletOrders, tableHead } = this.props
      ...
      <Paper className={ classes.root }>
          ...
          <div className={ classes.tableWrapper }>
            <Table className={ classes.table }>
              ...
              <TableBody>
              <ReactPlaceholder style={ { marginBottom: 20, padding: 20 } } showLoadingAnimation customPlaceholder={TableRowPlaceholder} rows={ 10 } ready={ walletOrders.completed } >
              ...
              <TableFooter>
                <TableRow>
                  <TablePagination
                    colSpan={ 3 }
                    count={ walletOrders?.data?.length }
