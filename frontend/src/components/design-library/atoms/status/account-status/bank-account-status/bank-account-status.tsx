...
const BankAccountStatus: React.FC<BankAccountStatusProps> = ({
  ...
  const statusList = [
    ...
    { status: 'validated', label: 'Active', color: 'active', icon: <ActiveIcon sx={styles.active} /> },
    { status: 'verified', label: 'Active', color: 'active', icon: <ActiveIcon sx={styles.active} /> },
    { status: 'errored', label: 'Inactive', color: 'inactive', icon: <InactiveIcon sx={styles.inactive} />, message: 'Your bank account is inactive. Please complete all required information. If your account remains inactive, contact support at issues@gitpay.me for assistance.' },
    { status: 'verification_failed', label: 'Inactive', color: 'inactive', icon: <InactiveIcon sx={styles.inactive} />, message: 'Your bank account is inactive. Please complete all required information. If your account remains inactive, contact support at issues@gitpay.me for assistance.' },
