...
const PayoutsDashboardCard = ({
  ...
  return (
    <DashboardCardBase
      image={payoutIcon}
      title={<FormattedMessage id="account.profile.payouts.headline" defaultMessage="Payouts in {currency}" values={{ currency: currency.toUpperCase() }} />}
      subheader={
        <>
          <FormattedMessage id="account.profile.payouts.overview" defaultMessage="{total} payouts" values={{ total }} />
          <br />
          <FormattedMessage id="account.profile.payouts.amount" defaultMessage="{amount} in payouts" values={{ amount: finalAmount }} />
        </>
      }
    ...
    >
      <DashboardCardChipList>
        ...
        <Chip size='small' label={<FormattedMessage id="account.profile.payouts.chip.in_transit" defaultMessage="{in_transit} in transit" values={{ in_transit }} />} color="info" />
