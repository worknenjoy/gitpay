...
const PaymentRequestsDashboardCard = ({ paymentRequests }) => {
  ...
  return (
    <DashboardCardBase
      ...
      title={
        <FormattedMessage
          id="account.profile.paymentRequests.headline"
          defaultMessage="Payment Requests"
        />
      }
      subheader={
        <FormattedMessage
          id="account.profile.paymentRequests.overview"
          defaultMessage="{total} payment requests links created"
          values={{ total }}
        />
      }
      buttonText={
        <FormattedMessage
          id="account.profile.paymentRequests.buttonText"
    ...
    >
      <DashboardCardChipList>
        <Chip
          ...
          label={
            <FormattedMessage
              id="account.profile.paymentRequests.chip.payments"
              defaultMessage="{payments} payment(s)"
              values={{ payments }}
            />
          }
          color="success"
        ...
        <Chip
          ...
          label={
            <FormattedMessage
              id="account.profile.paymentRequests.chip.amount"
