...
const GitHubLogo = () => (
  <img
    ...
    height='16'
    src={logoGithub}
    style={{ borderRadius: '50%', backgroundColor: 'black', padding: 2, display: 'block', flexShrink: 0 }}
  />
)
...
const projectHeader = (
  <Box display='flex' justifyContent='space-between' alignItems='flex-start' mb={1}>
    ...
    <Chip label='8 open' size='small' color='warning' variant='outlined' sx={{ ml: 1, flexShrink: 0, height: 22, fontSize: 11 }} />
  </Box>
)
  ...
  <>
    <Box display='flex' gap={2}>
      <Typography variant='caption' color='text.secondary'>
        Paid out <Box component='span' fontWeight={700} color='text.primary'>$2,500</Box>
      </Typography>
      <Typography variant='caption' color='text.secondary'>
        Issues <Box component='span' fontWeight={700} color='text.primary'>11</Box>
      </Typography>
    </Box>
  ...
  <Box maxWidth={380}>
    <ResourceCard header={projectHeader} footer={projectFooter}>
      <Typography
        ...
        sx={{ mb: 1.5, display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden', lineHeight: 1.5 }}
      >
        Payment platform for open-source work delivered. Bounties, payment requests, and more.
      </Typography>
      <Box display='flex' gap={0.75} flexWrap='wrap'>
        {['TypeScript', 'React', 'Node'].map((lang) => (
          <Chip key={lang} label={lang} size='small' variant='outlined' sx={{ height: 22, fontSize: 11 }} />
        ))}
      </Box>
    </ResourceCard>
  </Box>
...
const orgHeader = (
  <Box display='flex' justifyContent='space-between' alignItems='flex-start' mb={1}>
    <Box display='flex' alignItems='center' gap={0.75} minWidth={0} overflow='hidden' flexShrink={1}>
      <Avatar sx={{ width: 20, height: 20, fontSize: 11, bgcolor: 'primary.main', flexShrink: 0 }}>W</Avatar>
      <Typography variant='subtitle2' fontWeight={700} noWrap>
        worknenjoy
      </Typography>
    </Box>
    <Chip label='3 projects' size='small' variant='outlined' sx={{ ml: 1, flexShrink: 0, height: 22, fontSize: 11 }} />
  </Box>
)
...
const orgFooter = (
  <>
    <Box display='flex' gap={2}>
      <Typography variant='caption' color='text.secondary'>
        Bounties <Box component='span' fontWeight={700} color='text.primary'>$150</Box>
      </Typography>
      <Typography variant='caption' color='text.secondary'>
        Open issues <Box component='span' fontWeight={700} color='text.primary'>3</Box>
      </Typography>
    </Box>
...
const minimalHeader = (
  <Box display='flex' justifyContent='space-between' alignItems='flex-start' mb={1}>
    <Box display='flex' alignItems='center' gap={0.75} minWidth={0} overflow='hidden' flexShrink={1}>
      <GitHubLogo />
      <Typography variant='body2' color='text.secondary' noWrap sx={{ flexShrink: 0 }}>acme</Typography>
      <Typography variant='body2' color='text.secondary' sx={{ flexShrink: 0 }}>/</Typography>
      <Typography variant='subtitle2' fontWeight={700} noWrap>minimal-project</Typography>
    </Box>
  </Box>
)
...
const minimalFooter = (
  <>
    <Typography variant='caption' color='text.secondary'>
      Issues <Box component='span' fontWeight={700} color='text.primary'>2</Box>
    </Typography>
    <ViewLink label='View project' />
  </>
)
...
const longNameHeader = (
  <Box display='flex' justifyContent='space-between' alignItems='flex-start' mb={1}>
    <Box display='flex' alignItems='center' gap={0.75} minWidth={0} overflow='hidden' flexShrink={1}>
      <Avatar sx={{ width: 20, height: 20, fontSize: 11, bgcolor: 'secondary.main', flexShrink: 0 }}>U</Avatar>
      <Typography variant='subtitle2' fontWeight={700} noWrap>
        this-organization-has-a-very-long-name-that-should-truncate
      </Typography>
    </Box>
    <Chip label='12 projects' size='small' variant='outlined' sx={{ ml: 1, flexShrink: 0, height: 22, fontSize: 11 }} />
  </Box>
)
  ...
  <Box maxWidth={380}>
    <ResourceCard header={longNameHeader} footer={orgFooter}>
      <Typography variant='body2' color='text.secondary' sx={{ display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden', lineHeight: 1.5 }}>
        Testing that long organization and project names truncate cleanly without breaking the card layout.
      </Typography>
    </ResourceCard>
  </Box>
)
      ...
      <ResourceCard header={projectHeader} footer={projectFooter}>
        ...
        <Box display='flex' gap={0.75}>
          {['TypeScript', 'React'].map((l) => (
            <Chip key={l} label={l} size='small' variant='outlined' sx={{ height: 22, fontSize: 11 }} />
          ))}
        </Box>
      </ResourceCard>
    </Grid>
