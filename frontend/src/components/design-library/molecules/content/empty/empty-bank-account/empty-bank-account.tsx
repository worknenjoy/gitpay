...
const EmptyBankAccount = ({
  ...
  return (
    <EmptyBase
      text={<FormattedMessage id="emptyBankAccount.text" defaultMessage="No bank account registered" />}
      actionText={<FormattedMessage id="emptyBankAccount.actionText" defaultMessage="Setup Bank Account" />}
