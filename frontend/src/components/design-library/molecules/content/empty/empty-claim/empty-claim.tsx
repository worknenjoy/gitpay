...
const EmptyClaim = ({
  ...
  return (
    <EmptyBase
      ...
      secondaryText={<FormattedMessage id="emptyClaim.secondaryText" defaultMessage="Activate your account to start making claims on bounties and payment requests." />}
