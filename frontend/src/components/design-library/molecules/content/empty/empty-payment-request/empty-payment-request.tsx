...
const EmptyPaymentRequest = ({
  ...
  return (
    <EmptyBase
      text={<FormattedMessage id="emptyPaymentRequest.text" defaultMessage="You have no payment requests yet" />}
      actionText={<FormattedMessage id="emptyPaymentRequest.actionText" defaultMessage="Make your first Payment Request" />}
