...
const StatusField = ({ status }) => {
  const classes = useStyles();
    ...
    const statusList = [
      ...
      { status: 'in_transit', label: 'Inactive', color: 'in_transit', icon: <ActiveIcon className={classes.in_transit} />, message: 'Your payout is in transit and will be in your bank account soon.' },
