...
const StatusField = ({ status }) => {
  const classes = useStyles();
    ...
    const statusList = [
      { status: 'pending', label: 'Pending', color: 'pending', icon: <InfoIcon className={classes.pending} />, message: 'Your payout is pending. Please provide additional information to complete your profile.' },
      { status: 'created', label: 'Active', color: 'created', icon: <ActiveIcon className={classes.created} /> },
      { status: 'in_transit', label: 'Inactive', color: 'in_transit', icon: <ActiveIcon className={classes.in_transit} />, message: 'Your payout is in_transit and will be in your bank account soon.' },
