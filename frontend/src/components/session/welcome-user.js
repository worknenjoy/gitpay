...
export default class WelcomeUser extends Component {
      ...
      render() {
            const content = {
                  "0": { textHeading: 'Be rewarded by work done', textContent: 'Complete the course and you will be awarded with points and earn badges', image: welcome1 },
                  "1": { textHeading: 'Collaboration with others', textContent: 'You can easily collaborate with your colleagues and will be able to help each other', image: welcome2 },
                  "2": { textHeading: 'Work with projects you love', textContent: 'Get some fantastic online videos and content to learn more and gain extra knowledge', image: welcome3 }
            }
            return (
                  <Dialog
                  ...
                  >
                        ...
                        <MobileStepper
                              ...
                              nextButton={
                                    <Button
                                          size='small'
                                          onClick={() => this.setState((prevState) => ({ currentStepIndex: prevState.currentStepIndex + 1 }))}
