...
export const countryCurrencies = [
  ...
  { currency: 'Chilean Peso', symbol: '$', code: 'CLP', countries: ['CL'] },
  ...
  { currency: 'Egyptian Pound', symbol: 'E£', code: 'EGP', countries: ['EG'] },
  ...
  { currency: 'Moroccan Dirham', symbol: 'DH', code: 'MAD', countries: ['MA'] },
