...
import Introduction from '../../../../design-library/molecules/introduction/introduction'
import PickupTagList from '../../../../design-library/molecules/pickup-tag-list/pickup-tag-list'
  ...
  const dialogCoverInvite = () => {
    ...
    if (props.taskFundingDialog) {
      return (
        <React.Fragment>
          <Introduction
          title={ <FormattedMessage id='task.funding.title' defaultMessage='Invite someone to add bounties to this issue' />}
          image={props.taskCover}
        >
