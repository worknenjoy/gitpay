...
const mapStateToProps = (state: any) => {
  return {
    ...
    accountVerificationLink: state.accountVerificationLink
  }
}
...
const mapDispatchToProps = (dispatch: any) => {
  return {
    ...
    deleteAccount: () => dispatch(deleteAccount('stripe')),
    ...
    fetchAccountVerificationLink: () => dispatch(fetchAccountVerificationLink('stripe'))
  }
}
