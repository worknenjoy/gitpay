...
const api = {
  ...
  ACCOUNT_FIELDS_ROUTES: {
    external_account: '/profile/payout-settings/bank-account/bank-account-info',
    'individual.address.city': '/profile/payout-settings/bank-account/account-holder',
    'individual.address.line1': '/profile/payout-settings/bank-account/account-holder',
    'individual.address.postal_code': '/profile/payout-settings/bank-account/account-holder',
    'individual.address.state': '/profile/payout-settings/bank-account/account-holder',
    'individual.email': '/profile/payout-settings/bank-account/account-holder',
    'individual.phone': '/profile/payout-settings/bank-account/account-holder',
    'individual.dob.day': '/profile/payout-settings/bank-account/account-holder',
    'individual.dob.month': '/profile/payout-settings/bank-account/account-holder',
    'individual.dob.year': '/profile/payout-settings/bank-account/account-holder',
    'individual.first_name': '/profile/payout-settings/bank-account/account-holder',
    'individual.last_name': '/profile/payout-settings/bank-account/account-holder',
    'individual.personal_id_number': '/profile/payout-settings/bank-account/account-holder',
    'individual.type': '/profile/payout-settings/bank-account/account-holder',
    'tos_acceptance.date': '/profile/payout-settings/bank-account/account-holder',
    'tos_acceptance.ip': '/profile/payout-settings/bank-account/account-holder',
    'business_profile.url': '/profile/payout-settings/bank-account/account-holder',
    business_type: '/profile/payout-settings/bank-account/account-holder',
    'business_profile.mcc': '/profile/payout-settings/bank-account/account-holder',
    'individual.id_number': '/profile/payout-settings/bank-account/account-holder',
    'individual.ssn_last_4': '/profile/payout-settings/bank-account/account-holder'
  },
  ACCOUNT_REASONS: {
